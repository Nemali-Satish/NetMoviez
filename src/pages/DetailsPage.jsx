      ...
      <div className="container mx-auto px-3 py-16 lg:py-0 flex flex-col lg:flex-row gap-5 lg:gap-10 ">
        <div className="relative mx-auto lg:-mt-28 lg:mx-0 w-fit min-w-60">
          ...
          <button
            ...
            className="mt-3 w-full py-2 px-4 text-center bg-white text-black rounded font-bold text-lg hover:bg-red-500 hover:text-white hover:scale-105 transition-all flex justify-center items-center gap-4"
          >
            <span>
              <FaPlay />
            </span>
